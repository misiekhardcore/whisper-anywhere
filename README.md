...
| Model | Size | Notes |
|---|---|---|
| `iic/SenseVoiceSmall` | ~120 MB | Default, 50+ languages (auto-detect), MIT license, 15-17x faster than Whisper on CPU. **Explicit language codes**: zh, en, yue, ja, ko only. |
